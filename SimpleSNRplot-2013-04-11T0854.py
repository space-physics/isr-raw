...
isrselect(path+'d0346834.dt3.h5',odir,beamid,tlim,vlim,zlim,t0,showacf,showsamples,makeplot)
#alternating code 234ms and 12ms power plots
isrselect(path+'d0346834.dt0.h5',odir,beamid,tlim,vlim,zlim,t0,showacf,showsamples,makeplot)
