...
def isrNe2q(Fwd: xarray.DataArray):
    ...
    alphaO2[hotind] = 1.95e-7 * (300.0 / Te[hotind]) ** 0.56  # Te>1200K
    alphaO2[~hotind] = 1.95e-7 * (300.0 / Te[~hotind]) ** 0.70

    alphaNO[hotind] = 3.02e-7 * (300.0 / Te[hotind]) ** 0.56  # Te>1200K
    alphaNO[~hotind] = 3.50e-7 * (300.0 / Te[~hotind]) ** 0.69
